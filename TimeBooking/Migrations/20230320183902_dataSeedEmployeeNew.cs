...
{
    /// <inheritdoc />
    public partial class dataSeedEmployeeNew : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "EmployeeId", "EmployeeFirstName", "EmployeeLastName", "Entry", "Exit" },
                values: new object[] { new Guid("476d1037-e2c9-4e4a-aeee-307a6f25742c"), "FirstNameTest", "LastNameTest", new DateTime(2019, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(9999, 12, 31, 23, 59, 59, 999, DateTimeKind.Unspecified).AddTicks(9999) });
        }
    }
}
